use super::*;
use crate::eval_context::eval_context_tests::BasicQueryTesting;
use crate::exprs::AccessQuery;
...
#[test]
fn test_operator_eq_literal() -> crate::Result<()> {
    let query = AccessQuery::try_from(
        r#"Resources[ Type == "AWS::IAM::Role" ].Properties.Policy.Statement[*].Principal"#,
    )?;
    let value = PathAwareValue::try_from(crate::values::read_from(RESOURCES)?)?;
...
#[test]
fn test_operator_eq_queries() -> crate::Result<()> {
    let s3_keys = [
...
#[test]
fn test_operator_eq_query_to_scalar_literal_ok() -> crate::Result<()> {
    let lhs_prefix = "/LHS";
...
#[test]
fn test_operator_in_scalar_literal_to_query_ok() -> crate::Result<()> {
...
#[test]
fn test_operator_in_list_literal_to_query_ok() -> crate::Result<()> {
...
#[test]
fn test_operator_in_query_to_scalar_ok() -> crate::Result<()> {
    let scalar_literal_value = PathAwareValue::String((Path::root(), "*".to_string()));
    let scalar_literal = vec![QueryResult::Literal(Rc::new(scalar_literal_value.clone()))];
    let scalar_query_value = PathAwareValue::String((Path::root(), "*".to_string()));
    let scalar_query_list_value = PathAwareValue::List((
...
#[test]
fn test_operator_in_query_to_scalar_in_string_ok() -> crate::Result<()> {
...
#[test]
fn test_operator_in_query_to_scalar_in_string_not_ok() -> crate::Result<()> {
    let scalar_literal_value = PathAwareValue::String((Path::root(), "*,ec2*,s3*".to_string()));
    let scalar_literal = vec![QueryResult::Literal(Rc::new(scalar_literal_value.clone()))];
    let scalar_query_value = PathAwareValue::String((Path::root(), "*".to_string()));
    let scalar_query_list_value = PathAwareValue::List((
...
#[test]
fn test_operator_in_query_to_query_ok() -> crate::Result<()> {
...
#[test]
fn test_operator_in_query_to_query_not_ok() -> crate::Result<()> {
    let lhs_value_path_str = "/LHS".to_string();
    let lhs_scalar_value = PathAwareValue::String((
        Path::new(format!("{}/Scalar", lhs_value_path_str), 0, 0),
        "*".to_string(),
...
#[test]
fn test_operator_in_literal_list_in_query_ok() -> crate::Result<()> {
...
#[test]
fn test_operator_in_scalar_literal_to_query_ok_with_unresolved() -> crate::Result<()> {
...
#[test]
fn test_operator_eq_vs_in_from_queries() -> crate::Result<()> {
    let custom =
...
#[test]
fn test_operator_not_eq() -> crate::Result<()> {
