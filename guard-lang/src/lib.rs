...
use crate::exprs::{ParameterizedRule, QueryPart};
...
pub struct UnResolved {
    pub traversed_to: Rc<PathAwareValue>,
...
impl QueryResult {
    pub fn resolved(&self) -> Option<Rc<PathAwareValue>> {
    ...
    pub fn unresolved_traversed_to(&self) -> Option<Rc<PathAwareValue>> {
...
#[derive(Debug, Clone, PartialEq, Serialize)]
pub struct ComparisonClauseCheck {
    pub comparison: (CmpOperator, bool),
    pub from: QueryResult,
    pub to: Option<QueryResult>, // happens with from is unresolved
...
#[derive(Debug, Clone, PartialEq, Serialize)]
pub struct InComparisonCheck {
    pub comparison: (CmpOperator, bool),
    pub from: QueryResult,
    pub to: Vec<QueryResult>, // happens with from is unresolved
    pub message: Option<String>,
    pub custom_message: Option<String>,
    pub status: Status,
}
...
#[derive(Debug, Clone, PartialEq, Serialize)]
pub struct UnaryValueCheck {
    pub value: ValueCheck,
    pub comparison: (CmpOperator, bool),
}

#[derive(Debug, Clone, PartialEq, Serialize)]
pub struct MissingValueCheck<'value> {
    pub rule: &'value str,
    pub message: Option<String>,
    pub custom_message: Option<String>,
    pub status: Status,
...
#[derive(Debug, Clone, PartialEq, Serialize)]
pub struct TypeBlockCheck<'value> {
    pub type_name: &'value str,
    pub block: BlockCheck,
}

#[derive(Debug, Clone, PartialEq, Serialize)]
pub struct BlockCheck {
    pub at_least_one_matches: bool,
    pub status: Status,
    pub message: Option<String>,
}

#[derive(Debug, Clone, PartialEq, Serialize)]
pub struct NamedStatus<'value> {
    pub name: &'value str,
    pub status: Status,
    pub message: Option<String>,
}
...
pub fn read_file_content(file: std::fs::File) -> Result<String> {
    use std::io::Read;
