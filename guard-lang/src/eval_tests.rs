use crate::eval_context::print_verbose_tree;
...
use crate::eval_context::{root_scope, EventRecord, RecordTracker};
...
fn parameterized_evaluations() -> Result<()> {
    ...
    print_verbose_tree(&top, &mut writer);
    assert_eq!(status, Status::FAIL);
