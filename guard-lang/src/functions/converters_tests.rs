...
#[test]
fn test_parse_int() -> crate::Result<()> {
    let value_str = r#"
    Resources:
      SecurityGroup:
...
#[test]
fn test_parse_float() -> crate::Result<()> {
    let value_str = r#"
    Resources:
      SecurityGroup:
        Type: AWS::EC2::SecurityGroup
...
#[test]
fn test_parse_boolean() -> crate::Result<()> {
    let value_str = r#"
    Resources:
      SecurityGroup:
        Type: AWS::EC2::SecurityGroup
...
#[test]
fn test_parse_string() -> crate::Result<()> {
    let value_str = r#"
    Resources:
      SecurityGroup:
        Type: AWS::EC2::SecurityGroup
...
#[test]
fn test_parse_char() -> crate::Result<()> {
    let value_str = r#"
{
    "Resources": {
        "SecurityGroup": {
