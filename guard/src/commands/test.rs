...
use crate::commands::files::{
    alpabetical, get_files_with_filter, iterate_over, last_modified, regular_ordering,
};
...
"#,
            ...
            .arg(
                Arg::with_name("last-modified")
                    .long("last-modified")
                    .short("m")
                    .required(false)
                    .conflicts_with("alphabetical")
